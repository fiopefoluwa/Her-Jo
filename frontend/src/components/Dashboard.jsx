              ...
              <Dialog open={isOpen} onOpenChange={setIsOpen}>
                ...
                <DialogContent className="sm:max-w-[425px] bg-card border-border/40">
                  <form onSubmit={handleCreateCircle}>
                    <DialogHeader>
                      <DialogTitle className="font-playfair text-2xl text-foreground">Create a Savings Circle</DialogTitle>
                    ...
                    <div className="grid gap-4 py-4">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="grid gap-2">
                          <Label htmlFor="contribution" className="text-foreground">Monthly Contribution (₦)</Label>
                          <Input
                            id="contribution"
                            type="number"
                            placeholder="50000"
                      ...
                      <Link to={`/circle/${circle.id}`}>
                        <div className="flex items-start justify-between mb-4">
                          <div>
                            ...
                            <div className="flex items-center gap-4 text-sm text-muted-foreground">
                              ...
                              <span>•</span>
                              <span>{circle.monthlyContributionFormatted || `₦${circle.monthlyContribution?.toLocaleString()}`}/month</span>
                            </div>
                          </div>
                          ...
                          <div className={`px-3 py-1 rounded-full text-xs font-medium ${
                            ...
                            {circle.nextPayout === "You" ? "Your Turn Soon" : circle.status === "completed" ? "Completed" : "Active"}
                          </div>
                        </div>
                        ...
                        <div className="mt-4 relative h-2 bg-muted rounded-full overflow-hidden">
                          <motion.div
                            ...
                            initial={{ width: 0 }}
                            animate={{ width: circle.totalCycles > 0 ? `${(circle.currentCycle / circle.totalCycles) * 100}%` : '0%' }}
                ...
                <div className="space-y-4">
                  {loading ? (
                    ...
                    recentActivity.map((activity, index) => (
                      <div key={activity.id || index} className="flex items-start gap-3 pb-4 border-b border-border/40 last:border-0 last:pb-0">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {activity.recipient && (
                            <div className="text-xs text-primary font-medium mt-1">Recipient: {activity.recipient}</div>
                          )}
                        </div>
