...
import { ArrowRight, Shield, Users, TrendingUp, Sparkles, Play, ChevronRight, ChevronLeft } from "lucide-react";
  ...
  const demoSteps = [
    {
      ...
      description: "Form a digital Esusu/Ajo circle with family or trusted traders. Set custom contribution amounts and invite members seamlessly.",
      visual: (
        <div className="bg-card border border-border/40 p-6 rounded-xl space-y-4 shadow-inner max-w-sm mx-auto text-left">
          <div className="font-playfair text-xl font-bold border-b border-border/40 pb-2 text-foreground">Market Women Alliance</div>
    ...
    },
    {
      ...
      description: "As you make on-time contributions, your Trust Score rises. This score is represented visually as a gorgeous traditional African clay vessel that becomes richer in detail.",
      visual: (
    ...
    },
    {
      ...
      description: "When your turn arrives in the rotation schedule, you receive the full pooled payout instantly. The cycle continues transparently until all members are paid.",
      visual: (
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Button size="lg" variant="outline" onClick={() => { setIsDemoOpen(true); setDemoStep(0); }}>
                Watch Demo
              </Button>
            </div>
